"""Alembic environment configuration for Tournament Director.

Supports async migrations across SQLite, PostgreSQL, MySQL, and MariaDB.
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        # Cross-database compatibility options
...
async def run_async_migrations() -> None:
    ...
    # Remove sync-only poolclass for async engine
    if "poolclass" in configuration:
        del configuration["poolclass"]
